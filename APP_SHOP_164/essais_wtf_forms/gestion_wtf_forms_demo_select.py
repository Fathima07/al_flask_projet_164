...
from APP_SHOP_164.erreurs.msg_erreurs import *
from APP_SHOP_164.essais_wtf_forms.wtf_forms_demo_select import DemoFormSelectWTF
    ...
    try:
        ...
        if request.method == "GET":
            ...
            for i in data_genres:
                genre_val_list_dropdown.append(i['brand_title'])
