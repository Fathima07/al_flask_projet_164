...
class FormWTFAddFilm(FlaskForm):
    ...
    """
    nom_film_regexp = ""
    nom_film_add_wtf = StringField("Nom du Product ", validators=[Length(min=2, max=2000, message="min 2 max 20"),
    ...
    submit = SubmitField("Enregistrer Product")
...
class FormWTFUpdateFilm(FlaskForm):
    ...
    duree_film_update_wtf = IntegerField("Durée du Product (minutes)", validators=[NumberRange(min=1, max=5000,
    ...
    description_film_update_wtf = StringField("Description du Product ", widget=TextArea())
    cover_link_film_update_wtf = StringField("Lien de l'affiche du Product ", widget=TextArea())
    datesortie_film_update_wtf = DateField("Date de sortie du Product", validators=[InputRequired("Date obligatoire"),
...
class FormWTFDeleteFilm(FlaskForm):
    ...
    """
    nom_film_delete_wtf = StringField("Effacer ce Product")
    submit_btn_del_film = SubmitField("Effacer Product")
